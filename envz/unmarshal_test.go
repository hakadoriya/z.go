...
func TestMarshal(t *testing.T) {
	...
	t.Run("error,ErrInvalidType,int", func(t *testing.T) {
		...
		var v int
		err := Unmarshal(v)
		if !errors.Is(err, envcorez.ErrInvalidType) {
			t.Errorf("❌: !errors.Is(err, envcorez.ErrInvalidType): %+v", err)
		}
	})
	...
	t.Run("error,ErrStructFieldCannotBeSet", func(t *testing.T) {
		...
		err := Unmarshal(&v)
		if !errors.Is(err, envcorez.ErrStructFieldCannotBeSet) {
			t.Errorf("❌: !errors.Is(err, envcorez.ErrStructFieldCannotBeSet): %+v", err)
		}
	})
	...
	t.Run("error,ErrInvalidTagValue", func(t *testing.T) {
		...
		err := Unmarshal(&v)
		if !errors.Is(err, envcorez.ErrInvalidTagValue) {
			t.Errorf("❌: !errors.Is(err, envcorez.ErrInvalidTagValue): %+v", err)
		}
	})
	...
	t.Run("error,required,ErrRequiredEnvironmentVariableNotFound", func(t *testing.T) {
		...
		err := Unmarshal(&v)
		if !errors.Is(err, envcorez.ErrRequiredEnvironmentVariableNotFound) {
			t.Errorf("❌: !errors.Is(err, envcorez.ErrRequiredEnvironmentVariableNotFound): %+v", err)
		}
	})
...
func Test_marshal(t *testing.T) {
	...
	t.Run("error,ErrStructFieldTypeNotSupported,struct", func(t *testing.T) {
		...
		err := unmarshal(testPkg, &v)
		if !errors.Is(err, envcorez.ErrStructFieldTypeNotSupported) {
			t.Errorf("❌: !errors.Is(err, envcorez.ErrStructFieldTypeNotSupported): %+v", err)
		}
	})

...
func IsHelp(err error) bool {
	return errors.Is(err, clierrz.ErrHelp)
}
...
func (c *Command) checkHelp() error {
	...
	if err == nil && helpRequested {
		clicorez.Logger.Debug("checkHelp: " + strings.Join(c.allExecutedCommandNames, " "))
		c.showUsage()
...
func DefaultUsage(c *Command) {
	clicorez.Logger.Debug("DefaultUsage: " + c.Name)
	...
	// Output
	_, _ = io.WriteString(c.GetStderr(), usage)
}

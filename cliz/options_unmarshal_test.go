...
func TestCommand_Unmarshal(t *testing.T) {
	...
	t.Run("success,", func(t *testing.T) {
		...
		var v testStruct
		err = UnmarshalOptions(c, &v, WithUnmarshalOptionsOptionTagKey(clicorez.TagKey))
		requirez.NoError(t, err)
	})

	t.Run("error,Ptr,clicorez.ErrInvalidType", func(t *testing.T) {
		t.Parallel()
		...
		requirez.ErrorIs(t, err, clicorez.ErrInvalidType)
	})

	t.Run("error,Struct,clicorez.ErrInvalidType", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("error,clicorez.ErrStructFieldCannotBeSet", func(t *testing.T) {
		t.Parallel()
		...
		err = UnmarshalOptions(c, &v)
		requirez.ErrorIs(t, err, clicorez.ErrStructFieldCannotBeSet)
	})

	t.Run("error,clicorez.ErrInvalidTagValue", func(t *testing.T) {
		t.Parallel()
		...
		err = UnmarshalOptions(c, &v)
		requirez.ErrorIs(t, err, clicorez.ErrInvalidTagValue)
	})

	t.Run("error,string,clicorez.ErrUnknownOption", func(t *testing.T) {
		t.Parallel()
		...
		err = UnmarshalOptions(c, &v)
		requirez.ErrorIs(t, err, clicorez.ErrUnknownOption)
	})

	t.Run("error,bool,clicorez.ErrUnknownOption", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("error,int64,clicorez.ErrUnknownOption", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("error,uint64,clicorez.ErrUnknownOption", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("error,float64,clicorez.ErrUnknownOption", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("error,clicorez.ErrFieldTypeNotSupported", func(t *testing.T) {
		t.Parallel()
		...
		err = UnmarshalOptions(c, &v)
		requirez.ErrorIs(t, err, clicorez.ErrStructFieldTypeNotSupported)
	})
}

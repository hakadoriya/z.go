...
func TestCommand_checkOptions(t *testing.T) {
	...
	t.Run("failure,ErrDuplicateOption,Name", func(t *testing.T) {
		t.Parallel()
		c := &Command{
			Name: "main-cli",
			SubCommands: []*Command{
	...
	t.Run("failure,ErrDuplicateOption,Aliases", func(t *testing.T) {
		t.Parallel()
		c := &Command{
			Name: "main-cli",
			SubCommands: []*Command{
	...
	t.Run("failure,ErrDuplicateOption,Environment", func(t *testing.T) {
		t.Parallel()
		c := &Command{
			Name: "main-cli",
			SubCommands: []*Command{

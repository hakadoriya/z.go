...
//
//	-X github.com/hakadoriya/z.go/buildinfo.buildVersion=`git describe --tags --exact-match HEAD 2>/dev/null || git rev-parse --short HEAD`
...
// Expected -ldflags value:
//
//	-X github.com/hakadoriya/z.go/buildinfo.buildRevision=`git rev-parse HEAD`
...
// Expected -ldflags value:
//
//	-X github.com/hakadoriya/z.go/buildinfo.buildBranch=`git rev-parse --abbrev-ref HEAD | tr / -`
...
// Expected -ldflags value:
//
//	-X github.com/hakadoriya/z.go/buildinfo.buildTimestamp=`git log -n 1 --format='%cI'`"

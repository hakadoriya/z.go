...
func WithHandlerOptions(o *slog.HandlerOptions) HandlerOption { return withHandlerOptions{o: o} }

type withErrorVerbose struct{ errorVerbose bool }

func (o withErrorVerbose) apply(s *slogHandler)   { s.errorVerbose = o.errorVerbose }
func WithErrorVerbose(verbose bool) HandlerOption { return withErrorVerbose{errorVerbose: verbose} }
